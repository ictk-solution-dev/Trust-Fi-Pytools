...
class MyFrame(Frame):
    ...
    def __init__(self, master):
        ...
        lblComment = Label(self.F1_4, text="", width=10)
        lblComment.pack(side=LEFT, padx=10, pady=10)

        btnOK = Button(self.F1_4, text="Erase", command=self.button_reset)
        btnOK.pack(side=LEFT, padx=20, pady=10)

        self.txtComment1_4 = tk.Entry(self.F1_4, width=50)
        self.txtComment1_4.pack(side=LEFT, padx=100, pady=10)
        self.txtComment1_4.insert(END, "Result")

        lblComment = Label(self.F1_5, text="", width=10)
        lblComment.pack(side=LEFT, padx=10, pady=10)

        btnOK = Button(self.F1_5, text="Connect", command=self.button_connect)
        btnOK.pack(side=LEFT, padx=20, pady=10)

        self.txtComment1_5 = tk.Entry(self.F1_5, width=50)
        self.txtComment1_5.pack(side=LEFT, padx=100, pady=10)
